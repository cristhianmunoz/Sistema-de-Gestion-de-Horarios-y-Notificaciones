...
Característica: Priorizar voluntarios
  ...
  Esquema del escenario: Priorizar voluntarios confirmados en base a una habilidad requerida
    ...
    Ejemplos:
      ...
      | 3      | "Rcp"          | {"voluntario1": {"nombre":"Andres", "apellido":"Soto", "horas_experiencia": [55.0, 125.0], "habilidad": ["Rcp","Anestesiar"]}, "voluntario2":{"nombre":"Elizabeth","apellido":"Alma","horas_experiencia":[105.0],"habilidad":["Anestesiar"]}}| ['Andres Soto', 'Elizabeth Alma']|